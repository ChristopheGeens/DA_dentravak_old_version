...
public class SandwichOrderControllerIntegrationTest extends AbstractControllerIntegrationTest {
    ...
    public void testPostSandwichOrder() throws JSONException {
        SandwichOrder sandwichOrder = aSandwichOrder().forSandwich(savedSandwich).withBreadType(BreadTypeEnum.BOTERHAMMEKES).withMobilePhoneNumber("0487/123456").build();
